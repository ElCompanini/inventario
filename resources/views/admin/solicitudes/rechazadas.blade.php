...
<div class="bg-white dark:bg-slate-800 rounded-xl shadow border border-gray-100 dark:border-slate-700
    ...
    <div class="max-w-sm">
        <p class="text-lg font-semibold text-gray-700 dark:text-gray-200">No hay solicitudes rechazadas</p>
        <p class="text-sm text-gray-400 dark:text-slate-500 mt-2 leading-relaxed">
            No se han registrado solicitudes rechazadas en el historial.
        </p>
    </div>
</div>
@endif

<div class="bg-white rounded-xl shadow overflow-hidden p-4" @if($solicitudes->isEmpty()) style="display:none" @endif>
