...
<div class="mb-4" style="max-width:560px; margin-left:auto; margin-right:auto;">
    <h1 class="text-lg font-bold text-gray-800 dark:text-gray-100 mt-0.5">Cambiar contrasena</h1>
    <p class="text-sm text-gray-500 dark:text-gray-400">Actualiza la contrasena de tu propia cuenta.</p>
</div>
...
<div class="bg-white dark:bg-slate-800 rounded-xl shadow p-5 mx-auto border border-gray-100 dark:border-slate-700" style="max-width:560px;">
    <form method="POST" action="{{ route('password.change.update') }}" class="space-y-4">
        ...
        <div>
            <label class="block text-xs font-semibold text-gray-600 dark:text-gray-300 mb-1">Nueva contrasena</label>
        ...
        <div>
            <label class="block text-xs font-semibold text-gray-600 dark:text-gray-300 mb-1">Confirmar contrasena</label>
